...
export const Route = createFileRoute("/auth/callback")({
  ...
  head: () => ({
    meta: [
      { title: "Verifying — StudyAll" },
      { name: "description", content: "Verifying your StudyAll email sign-in link." },
      { property: "og:title", content: "Verifying — StudyAll" },
      { property: "og:description", content: "Verifying your StudyAll email sign-in link." },
